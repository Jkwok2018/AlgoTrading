...
if __name__ == "__main__":
    ...
    ######### Chapter 3 ###########
    # Plot different parameters for the beta distribution
    # visuals of the graph
    sns.set_palette("deep", desat=.6) 
    sns.set_context(rc={"figure.figsize": (8, 4)})
    # an array of points for the x-axis
    x = np.linspace(0, 1, 100) 
    # 5 different pairs of parameters (alpha, beta) for the beta distribution
    params = [(0.5, 0.5), (1, 1), (4, 3), (2, 5), (6, 6)]
    # get the pdf for each parameter and plot the line
    for p in params:
